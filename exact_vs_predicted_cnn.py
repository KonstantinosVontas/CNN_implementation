...
for i in range(4, 42, 2):
    ...
    training_data = training_data[0:300000][:] #CHANGE
    test_data = test_data[0:30][:] #CHANGE
...
model = CNN_Curv([1, 32, 32, 16, 1], [nn.CELU(), nn.Linear(32, 16), nn.CELU(), nn.Linear(16, 1)]) #CHANGE
...
checkpoint = torch.load("./best_model_300k_data_3000_LayerNorm_CELU_x2_Linear_batch_128.pth") #CHANGE
...
plt.legend()
plt.title(f"Curvature - 300k data, {number_of_samples} samples, CNN([LayerNorm(), CELU() x2, Linear()])", fontsize=6) # CHANGE
plt.savefig(f'./Exact_loss_testing_plots_best_model/Average_Loss_over_Radius_for_{number_of_samples}_samples_{n_epochs}_epochs_CNN_300k_data.pdf', dpi=300,  bbox_inches='tight') # CHANGE
plt.savefig(f'./Exact_loss_testing_plots_best_model/Average_Loss_over_Radius_for_{number_of_samples}_samples_{n_epochs}_epochs_CNN_300k_data.eps',
            dpi=700, format='eps', bbox_inches='tight') # CHANGE
plt.savefig(f'./Exact_loss_testing_plots_best_model/Average_Loss_over_Radius_for_{number_of_samples}_samples_{n_epochs}_epochs_CNN_300k_data.png',
...
plt.legend()
plt.title(f"Curvature - 300k data (samples averaged per tested radius), for {number_of_samples} samples, CNN([LayerNorm(), CELU() x2, Linear()])", fontsize=6) # CHANGE
plt.savefig(f'./Exact_loss_testing_plots_best_model/Averaged_values_per_radius_predicted_vs_exact_for_{number_of_samples}_samples_all_values_{n_epochs}_epochs_CNN_300k_data.pdf', dpi=300,  bbox_inches='tight') # CHANGE
plt.savefig(f'./Exact_loss_testing_plots_best_model/Averaged_values_per_radius_predicted_vs_exact_for_{number_of_samples}_samples_averaged_{n_epochs}_epochs_CNN_300k_data.eps',
            dpi=700, format='eps', bbox_inches='tight') # CHANGE
plt.savefig(f'./Exact_loss_testing_plots_best_model/Averaged_values_per_radius_predicted_vs_exact_for_{number_of_samples}_samples_averaged_{n_epochs}_epochs_CNN_300k_data.png',
            dpi=1200, format='png', bbox_inches='tight') # CHANGE
plt.show()
...
plt.plot(X_plot, m*X_plot + b, '-', c='r', linewidth = 0.7)
plt.legend()
plt.title(f"Curvature - 300k data, {number_of_samples} samples for each examined radius, CNN([LayerNorm(), CELU() x2, Linear()])", fontsize=6) # CHANGE
plt.savefig(f'./Exact_loss_testing_plots_best_model/Actual_values_per_radius_predicted_vs_exact_for_{number_of_samples}_samples_all_values_{n_epochs}_epochs_CNN_300k_data.pdf', dpi=300,  bbox_inches='tight')
plt.savefig(f'./Exact_loss_testing_plots_best_model/Actual_values_per_radius_predicted_vs_exact_for_{number_of_samples}_samples_all_values_{n_epochs}_epochs_CNN_300k_data.eps',
            dpi=700, format='eps', bbox_inches='tight')# CHANGE
plt.savefig(f'./Exact_loss_testing_plots_best_model/Actual_values_per_radius_predicted_vs_exact_for_{number_of_samples}_samples_all_values_{n_epochs}_epochs_CNN_300k_data.png',
            dpi=1200, format='png', bbox_inches='tight') # CHANGE
plt.show()
